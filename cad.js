...
var _cad_create_context = Module['_cad_create_context'] = makeInvalidEarlyAccess('_cad_create_context');
var _cad_destroy_context = Module['_cad_destroy_context'] = makeInvalidEarlyAccess('_cad_destroy_context');
var _cad_set_cursor_pos = Module['_cad_set_cursor_pos'] = makeInvalidEarlyAccess('_cad_set_cursor_pos');
var _cad_cursor_lost = Module['_cad_cursor_lost'] = makeInvalidEarlyAccess('_cad_cursor_lost');
...
var _type_register_static = Module['_type_register_static'] = makeInvalidEarlyAccess('_type_register_static');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['cad_create_context'] != 'undefined', 'missing Wasm export: cad_create_context');
  assert(typeof wasmExports['cad_destroy_context'] != 'undefined', 'missing Wasm export: cad_destroy_context');
  assert(typeof wasmExports['cad_set_cursor_pos'] != 'undefined', 'missing Wasm export: cad_set_cursor_pos');
  assert(typeof wasmExports['cad_cursor_lost'] != 'undefined', 'missing Wasm export: cad_cursor_lost');
  ...
  assert(typeof wasmExports['type_register_static'] != 'undefined', 'missing Wasm export: type_register_static');
  ...
  _cad_create_context = Module['_cad_create_context'] = createExportWrapper('cad_create_context', 0);
  _cad_destroy_context = Module['_cad_destroy_context'] = createExportWrapper('cad_destroy_context', 1);
  _cad_set_cursor_pos = Module['_cad_set_cursor_pos'] = createExportWrapper('cad_set_cursor_pos', 2);
  _cad_cursor_lost = Module['_cad_cursor_lost'] = createExportWrapper('cad_cursor_lost', 0);
  ...
  _type_register_static = Module['_type_register_static'] = createExportWrapper('type_register_static', 6);
